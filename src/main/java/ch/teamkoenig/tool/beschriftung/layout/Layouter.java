...
public class Layouter {
	public static void layout(final Collection<Drawable> things, final OutputStream target, final PageSize pageSize,
	...
	private static Drawable takeNextLayout(final Collection<Drawable> layouts, final float heightLimit,
