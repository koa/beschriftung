...
public class Grid {
  ...
  private void appendHorse(
      final List<Drawable> layouts,
      final String number,
      final String name,
  ...
  private Drawable takeNextLayout(
      final List<Drawable> layouts, final float heightLimit, final float widthLimit) {
